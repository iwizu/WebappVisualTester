...
{
    public partial class ScrollToElementCommandUC : UserControl
    {
        IProjectManager projectManager;
        ScrollToElementCommand command;
        Test test;
        EditTest parentForm;
        EditCommand mainCommandForm;

        public ScrollToElementCommandUC(ICommand command, Test test, EditTest parentForm, EditCommand mainCommandForm, IProjectManager projectManager)
        {
            InitializeComponent();
            this.command = command as ScrollToElementCommand;
            this.test = test;
